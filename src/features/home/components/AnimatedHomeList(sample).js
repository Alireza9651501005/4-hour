...
export default class AnimatedHomeList extends Component {
    ...
    _getLargeHeaderHeight = () => {
        ...
        return scrollY.interpolate({
            inputRange: [0, 140],
            outputRange: [verticalScale(228), verticalScale(60)],
            extrapolate: 'clamp',
            useNativeDriver: true,
        });
    };
    ...
    _getImageWidth = () => {
        ...
        return scrollY.interpolate({
            inputRange: [0, 50, 140],
            outputRange: [verticalScale(102), verticalScale(60), verticalScale(40)],
            extrapolate: 'clamp',
            useNativeDriver: true,
        });
    };
        ...
        return (
            <View style={styles1.container}>
                ...
                <View style={styles1.headerImageWrapper}>
                    <Animated.Image
                        style={[styles1.headerImageStyle, { opacity: headerImageOpacity, height: largeHeaderHeight }]}
                        source={require('../../../assets/images/common/header-bg-center.png')} />

                    {/* user levels achivments section*/}
                    {profile ? <Animated.View style={[styles1.levelsView, { opacity: normalTitleOpacity }]}>
                ...
                {/* purchase button */}
                {profile ? <Animated.View style={[styles1.purchaseIconWrapper, { opacity: normalTitleOpacity }]}>
                    <TouchableOpacity
                        style={{}}
                ...
                {!profile ?
                    ...
                    >
                        {'برای انجام تست دیسک ابتدا ثبت نام کنید'}
                    </Animated.Text> :
                    null
                }
