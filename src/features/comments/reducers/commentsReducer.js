...
const commentsReducer = (state = {
    ...
    switch (action.type) {
        ...
        case Actiontypes.SEND_COMMENT_PENDING:
            return { ...state, sendLoading: true, listData: action.payload , errorAll:false }

        case Actiontypes.SEND_COMMENT_ERROR:
            return { ...state, sendLoading: false, errorAll: action.error }
        ...
        case Actiontypes.MENTION_LIST_PENDING:
            return { ...state, mentionsLoading: true ,errorAll:false }

        case Actiontypes.MENTION_LIST_ERROR:
            return { ...state, mentionsLoading: false, errorAll: action.error }
        ...
        case Actiontypes.MENTIONS_VISIBLE:
            ...
            return { ...state, listData: action.payload,errorAll:false}

        case Actiontypes.REACTION_COMMENT_ERROR:
            return { ...state, errorAll: action.error }
